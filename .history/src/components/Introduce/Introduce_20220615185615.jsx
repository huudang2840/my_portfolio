  ...
  return (
    <div className="introduce" id="Introduce">
      ...
      <div className="cards">
        {/* Thẻ 1 */}
        <motion.div
          initial={{ top: "-10%", right: "30%" }}
          whileInView={{ top: "0", left: "20rem" }}
        ...
        {/* Thẻ 2 */}
        <motion.div
          initial={{ top: "10%", left: "-30%" }}
          whileInView={{ top: "12rem", left: "1rem" }}
          transition={transition}
        >
        ...
        {/* Thẻ 3 */}
        <motion.div
          initial={{ top: "80%%", right: "10%" }}
          whileInView={{ top: "19rem", left: "19rem" }}
          transition={transition}
        >
          <Card
            emoij={Blood}
