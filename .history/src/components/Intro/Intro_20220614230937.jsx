    ...
    <div className="intro">
      <div className="i-left">
        <div className="i-name">
          ...
          />
          <span>
            Là một người yêu thích công nghệ. <br />
            Thích được trải nghiệm và học hỏi những điều mới mẻ.
            <br />
            Luôn tìm kiếm những thử thách để ngày càng hoàn thiện bản thân
            <br />
            cũng như cùng được giao lưu, gặp gỡ, kết bạn với tất cả mọi người.
          </span>
        </div>
